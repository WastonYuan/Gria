...
*/
func (pwv *PWV) PreparationCost(thread_cnt int, opss [](t_txn.AccessPtr)) int {
	sum_c := 0
...
func (pwv *PWV) Prios(ops t_txn.AccessPtr) *(map[string]int) {
	return ops.ReadWriteMap(true)
}

func (pwv *PWV) NewTXN(txn_id int, ops t_txn.AccessPtr) t_txn.TxnPtr {
